...
public interface ActionMetaDao {
	 ...
	 * @return
	 */
	public void saveActionMeta(TActionMeta actionMeta);
	/**
	 * 根据id查动作类型
	 * @param id
	 * @return
	 ...
	 * @created 2013-4-18
	 */
	public TAction getActionAndMetaByIdAction(Integer actionId);
	public TActionMeta getActionAndMetaByIdActionMeta(Integer actionId);
	/**
	 * 添加动作类型变量
	 * 
	 * @param name
